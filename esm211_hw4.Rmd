...
In the interest of increasing λ1, our biggest response from the sensitivity model is to increase subadult survival, next would be to increase large juvenile survival followed by increasing adult survival. The smallest response would come from increasing reproduction of small juviniles. The proportional change seen in the elasticity matrix shows that increasing survival of adults would have the largest increase of λ1. Because we need to increase λ1 by 0.05 to reach 1, 
